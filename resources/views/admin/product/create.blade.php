                        ...
                        <form class="form-sample" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="form-check">
                                        <label class="form-check-label">
                                          <input type="radio" class="form-check-input" name="publishStatus" id="publishStatus1" value="yes" {{old('publishStatus') == 'yes' ? 'checked' : '' }}>
                                          Yes
                                        </label>
                                      </div>
                                    ...
                                    <div class="col-sm-5">
                                      <div class="form-check">
                                        <label class="form-check-label">
                                          <input type="radio" class="form-check-input" name="publishStatus" id="publishStatus2" value="no"  {{old('publishStatus') == 'no' ? 'checked' : '' }}>
                                          No
                                        </label>
                                      </div>
                                    </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" name="discountPrice" value="{{old('discountPrice')}}" />
                                    </div>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="float-left">
                                    <input type="submit" value="Create" class="btn btn-rounded btn-primary mb-2">
                                </div>
                              </div>
                          </form>
                    </div>
